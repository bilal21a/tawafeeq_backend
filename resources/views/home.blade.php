...
@section('content')
    ...
    <main>
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-5 col-md-5 col-sm-12 pb-3 p-sm-0 p-4 p-lg-5 padding_right_lg">
                    ...
                    <div class="card top-right-left-border">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-4 ps-0">
                                            ...
                                            <input type="number" name="age_from" id="age_from"
                                                class="form-control input_background" placeholder="العمر من">
                                        </div>
                                        <div class="col-md-4 ps-0">
                                            <h5 class="fw-semibold mb-1">العمر الى</h5>
                                            <input type="number" name="age_to" id="age_to"
                                                class="form-control input_background" placeholder="العمر الى">
                                        </div>
                                        <div class="col-md-4">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 p-sm-0 p-4 p-lg-5">
                    <div class="">
                        <img class="width_couple_pic" src="{{ asset('assets/img/find_partner.png') }}" alt=""
                            srcset="">
                    </div>
                </div>
            </div>
        ...
        <section class="scroll-section" dir="ltr" id="basic">
            ...
            @endforeach
            <br>
            <h2 class="mt-4" dir="rtl"><span class="fw-bold fs-4 ">خدماتنا</span></h2>
